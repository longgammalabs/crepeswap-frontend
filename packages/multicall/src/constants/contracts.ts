...
export const MULTICALL_ADDRESS: { [key in ChainId]?: Address } = {
  ...
  [ChainId.ETHERLINK_TESTNET]: '0xa318d3b9Af779Fae6429cA689bc2241d01F4C8D0',
  [ChainId.ETHERLINK]: '0xb0c3Da6fcBD970fF45cE9Ced5972486ef779C03d',
}
...
export const MULTICALL3_ADDRESSES: {
  ...
  [ChainId.ETHERLINK_TESTNET]: MULTICALL3_ADDRESS,
  [ChainId.ETHERLINK]: MULTICALL3_ADDRESS,
}
