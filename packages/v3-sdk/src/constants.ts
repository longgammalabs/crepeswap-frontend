...
export const FACTORY_ADDRESSES = {
  ...
  [ChainId.ETHERLINK_TESTNET]: '0xfaAdaeBdcc60A2FeC900285516F4882930Db8Ee8',
  [ChainId.ETHERLINK]: '0x093cCBAEcb0E0006c8BfFca92E9929d117fEC583',
...
export const DEPLOYER_ADDRESSES = {
  ...
  [ChainId.ETHERLINK_TESTNET]: '0x4497e43Ce3CECc96F28ceBa3dd06A1954a799e59',
  [ChainId.ETHERLINK]: '0xF4c7C130cd07737DE5C619a366E719646663ACf4',
} as const satisfies Record<ChainId, Address>
...
export const POOL_INIT_CODE_HASHES = {
  ...
  [ChainId.ETHERLINK]: POOL_INIT_CODE_HASH,
...
export const NFT_POSITION_MANAGER_ADDRESSES = {
  ...
  [ChainId.ETHERLINK_TESTNET]: '0x79b1a1445e53fe7bC9063c0d54A531D1d2f814D7',
  [ChainId.ETHERLINK]: '0x34f957BCD46A9B0f8fCCdcc945004cE03ac6bDb5',
} as const satisfies Record<ChainId, Address>
