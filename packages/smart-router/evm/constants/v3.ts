...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.ETHERLINK_TESTNET]: '0x7862280735637517A7C0CBA548427f32E557D78F',
  [ChainId.ETHERLINK]: '0x9AEb34Cb2b038b1F1df0E9079f3d223eEdc073E6',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.ETHERLINK_TESTNET]: '0x6e8432F0Ed242fABfA481dd449407b0f724d8D03',
  [ChainId.ETHERLINK]: '0xaB26D8163eaF3Ac0c359E196D28837B496d40634',
} as const satisfies Record<ChainId, Address>
...
export const V3_TICK_LENS_ADDRESSES = {
  ...
  [ChainId.ETHERLINK_TESTNET]: '0x8466878CfbCA4f8099cdD3a313469c8FED86DD33',
  [ChainId.ETHERLINK]: '0x0D943E4AC4294627B04691c1139aa2854ded2Fe6',
} as const satisfies Record<ChainId, Address>
