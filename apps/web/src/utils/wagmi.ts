...
import { BloctoConnector } from '@iguanadex/wagmi/connectors/blocto'
import { TrustWalletConnector } from '@iguanadex/wagmi/connectors/trustWallet'
...
export const coinbaseConnector = new CoinbaseWalletConnector({
  ...
  options: {
    appName: 'IguanaDEX',
    appLogoUrl: 'https://iguanadex.com/logo.png',
  },
})
