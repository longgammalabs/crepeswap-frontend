...
import { Box, Checkbox, Flex, Message, MessageText, Modal, Text } from '@iguanadex/uikit'
import { BIG_ZERO } from '@iguanadex/utils/bigNumber'
import { getBalanceAmount, getBalanceNumber, getDecimalAmount } from '@iguanadex/utils/formatBalance'
...
const AddAmountModal: React.FC<React.PropsWithChildren<AddAmountModalProps>> = ({
  ...
  return (
    <RoiCalculatorModalProvider lockedAmount={lockedAmount}>
      <Modal title={t('')} onDismiss={onDismiss} headerBackground={theme.colors.gradientCardHeader}>
        <Box mb="16px">
          <BalanceField
