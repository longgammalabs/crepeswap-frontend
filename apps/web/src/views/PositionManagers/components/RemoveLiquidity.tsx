...
import type { AtomBoxProps } from '@iguanadex/uikit'
import { Box, Button, Flex, ModalV2, RowBetween, Text, useToast } from '@iguanadex/uikit'
...
import { ConfirmationPendingContent, CurrencyLogo } from '@iguanadex/widgets-internal'
