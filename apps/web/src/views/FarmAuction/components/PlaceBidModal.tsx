...
import { CAKE, bscTokens } from '@iguanadex/tokens'
import { BalanceInput, Box, Button, Flex, LogoRoundIcon, Modal, Text, useToast } from '@iguanadex/uikit'
import { formatNumber, getBalanceAmount, getBalanceNumber } from '@iguanadex/utils/formatBalance'
...
const PlaceBidModal: React.FC<React.PropsWithChildren<PlaceBidModalProps>> = ({
  ...
  const isFirstBid = Boolean(amount?.isZero())
