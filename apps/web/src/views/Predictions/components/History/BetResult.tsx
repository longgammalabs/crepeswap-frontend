...
import { BetPosition, REWARD_RATE } from '@iguanadex/prediction'
import { BlockIcon, Box, Flex, Heading, InfoIcon, PrizeIcon, ScanLink, Text, useTooltip } from '@iguanadex/uikit'
