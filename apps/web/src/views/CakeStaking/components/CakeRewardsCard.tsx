    ...
    >
      ...
      >
        <StyledModalHeader headerBorderColor="transparent">
          <ModalTitle>
            <Heading scale="md">{t('IGN Reward / Yield')}</Heading>
          </ModalTitle>
        ...
        <ModalBody style={{ marginLeft: '-24px', marginRight: '-24px', paddingLeft: '24px', paddingRight: '24px' }}>
          ...
          <Text fontSize="14px" color="textSubtle" mb="16px" mt="13px">
            {t('From IGN pool rewards and revenue sharing!')}
          </Text>
          <MyVeCakeCard />
                  ...
                  <BenefitsTooltipsText
                    ...
                    tooltipComponent={
                      <div>
                        ...
                        <p>
                          {t(
                            'IGN Pool APR is calculated based on the voting result and the emission of the veCAKE Pool gauge.',
                          )}
                        </p>
                        <br />
                        <p>
                ...
                <Box mt="16px">
                  ...
                  <Flex mt="8px" flexDirection="row" alignItems="start">
                    <BenefitsTooltipsText
                      ...
                      tooltipComponent={<Text>{t('Amount of revenue available for claiming in IGN.')}</Text>}
                    />
                    <Box>
                      {availableCakePoolCake > 0 && availableCakePoolCake <= 0.01 ? (
                        <Text bold textAlign="right">{`< 0.01 IGN`}</Text>
                      ) : (
                        <Balance unit=" IGN" textAlign="right" bold value={availableCakePoolCake} decimals={2} />
                      )}
                      <Balance
                        ml="4px"
                        color="textSubtle"
                  ...
                  <Flex mt="8px" flexDirection="row" alignItems="start">
                    ...
                    <Box>
                      {availableRevenueSharingCake > 0 && availableRevenueSharingCake <= 0.01 ? (
                        ...
                        <Balance unit=" IGN" textAlign="right" bold value={availableRevenueSharingCake} decimals={2} />
                      )}
                      <Balance
                        ml="4px"
                        color="textSubtle"
                  ...
                  <Flex mt="8px" flexDirection="row" alignItems="start">
                    ...
                    <Box>
                      {totalAvailableClaim > 0 && totalAvailableClaim <= 0.01 ? (
                        ...
                        <Balance unit=" IGN" textAlign="right" bold value={totalAvailableClaim} decimals={2} />
                      )}
                      <Balance
                        ml="4px"
                        color="textSubtle"
