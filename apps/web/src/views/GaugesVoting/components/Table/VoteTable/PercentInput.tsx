import { BalanceInputProps, Box, Button, Flex, Text } from '@iguanadex/uikit'
import { StyledBalanceInput, StyledInput as UIKitStyledInput } from '@iguanadex/uikit/components/BalanceInput/styles'
