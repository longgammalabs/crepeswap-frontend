import { GAUGE_TYPE_NAMES, GaugeType } from '@iguanadex/gauges'
import { useTranslation } from '@iguanadex/localization'
import { Button, ChevronDownIcon, ChevronUpIcon, ErrorIcon, Flex, FlexGap, Grid, Tag, Text } from '@iguanadex/uikit'
