...
import { Box, CheckmarkCircleFillIcon, ErrorIcon, Flex, Image, Text } from '@iguanadex/uikit'
import { getBalanceAmount, getDecimalAmount } from '@iguanadex/utils/formatBalance'
        ...
        <Flex>
          <Box width={39}>
            <Image
              ...
              src={`${PANCAKE_ASSET_CDN}/web/vecake/token-vecake-with-time.png`}
            />
          </Box>
